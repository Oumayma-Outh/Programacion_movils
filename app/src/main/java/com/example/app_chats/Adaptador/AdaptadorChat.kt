...
/*Vistas de item de mensaje izquierdo */
        ...
        /*Vistas de item de mensaje derecho  */
    ...
    override fun onCreateViewHolder(
       ...
       return if(position == 1) {
           val view: View = LayoutInflater.from(contexto).inflate(com.example.app_chats.R.layout.item_mensaje_derecho, parent, false)
           ViewHolder(view)

       }else    {
           val view: View = LayoutInflater.from(contexto).inflate(com.example.app_chats.R.layout.item_mensaje_izquierdo, parent, false)
           ViewHolder(view)
